...
p2 <- ggplot(df, aes(fill = geographical.location, x = index)) + geom_histogram(alpha = 0.5, position = "dodge") + labs(x = "Shannon Diversity", y = "Density")
print(p2)
...
for (tax in top.taxa) {
  ...
  p <- ggplot(df, aes(x = geographical.location, y = taxa)) +
    geom_boxplot() + 
