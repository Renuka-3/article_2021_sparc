...
```{r group_comp, echo=FALSE, echo=FALSE, message=FALSE, fig.width=6, fig.height=6, fig.show="keep", out.width="50%"}
...
```{r diffab, echo=FALSE, message=FALSE, fig.width=7, fig.height=5, out.width="25%", fig.show="hold"}
theme_set(theme_bw(base_size=25))
library(readr)
library(tidyverse)
...
```{r diffab, echo=FALSE, message=FALSE}
