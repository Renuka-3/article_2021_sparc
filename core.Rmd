...
p4 <- ggplot(bs, aes(x = new, y = value)) +
       ...
       #scale_y_log10(label = scales::percent) +
       coord_flip() + theme(legend.position="none") +
       labs(y = "Mean relative abundance (%)", x = '', title = "Core abundance variation")
#print(p4)
```

```{r core_prevalance, echo=FALSE, warning=FALSE, message=FALSE, fig.width=22, fig.height=9, fig.show="hold"}
