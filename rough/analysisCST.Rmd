```{r initCST_CLR, message=F, warning=FALSE, echo=F, echo=FALSE}
library("phyloseq")
library("ggplot2")
library("cluster")
library("igraph")
...
```{r pcoa, echo=FALSE, message=FALSE, fig.width=14, fig.height=8, out.width="60%", fig.show="hold", warning=FALSE}
...
```{r full_names, echo=FALSE, results='hide'}
library(knitr)
