...
The following `r length(taxa)` taxonomic groups are detected with `r 100 * prev.th`% prevalence at `r 100 * det.th`% relative abundance: `r print(paste(taxa, collapse = ", "))`.
...
```{r DMM, out.width="33%", echo=FALSE, message=FALSE, warning=FALSE, fig.show="hold"}
